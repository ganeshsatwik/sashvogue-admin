...
const defaultHomepageConfig = {
  categories: [
    { key: 'men', label: 'MEN', image: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=600&auto=format&fit=crop&q=80', linkUrl: '/men' },
    { key: 'women', label: 'WOMEN', image: 'https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=600&auto=format&fit=crop&q=80', linkUrl: '/women' },
  ],
  newSeason: {
